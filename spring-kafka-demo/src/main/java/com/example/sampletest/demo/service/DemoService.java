...
import com.example.sampletest.demo.core.DBManager;
import com.example.sampletest.demo.core.KafkaManager;
import com.example.sampletest.demo.core.StdInfo;
...
//                .doOnNext(s -> logger.info("Create - id: {}\tname: {}\tmajor: {}",s.getId(), s.getName(), s.getMajor()))
    ...
    /***** general *****/
//    protected Flux<StdInfo> generateSource(){
